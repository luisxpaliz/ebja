package ec.gob.educacion.ebja.bean.pcei;
...
import ec.gob.educacion.ebja.enums.TipoSostenimientoServicioEducativoEnum;
...
@ManagedBean
@ViewScoped
public class InscripcionPceiBean extends BaseControlador implements Serializable {
	...
	private List<Provincia> listaProvinciaIe = new ArrayList<>();
	private List<Canton> listaCantonIe = new ArrayList<>();
	private List<Parroquia> listaParroquiaIe = new ArrayList<>();
	private List<String> sostenimientosIe = new ArrayList<>();
	private List<InstitucEstablec> institucionesEducativas = new ArrayList<>();
	
	
	private Provincia provinciaIe;
	private Canton cantonIe;
	private Parroquia parroquiaIe;
	private Zona zonaIe;
	private String sostenimientoIe;
	private InstitucEstablec institucionEducativa;
	private String etiquetaInstitucionEducativa;
	...
	private static final Logger LOGGER = Logger.getLogger(InscripcionPceiBean.class.getName());
	private Date ahoraTmp;

	public InscripcionPceiBean() {
	}
	...
	public void cargarCatalogos() {
		...
		listaRezagoEducativo = catalogoEbjaFacadeLocal
				.obtenerCatalogosPorTipoCatalogo(Constantes.NEMONICO_REZAGO_EDUCATIVO_PCEI);
	...
	//VALIDACION AGREGADA
	private void validacionesRezagoEducativo() {
	...
	public void activarCargarDocumentoPDF() {
		textosalida = "";
		ProgramaGrado programaGradoConsultado = programaGradoFacadeLocal.buscarProgramaGrado(gradoOfertaSeleccionadoInscripcion, programaOfertaInscripcion);
		if (programaGradoConsultado != null && programaGradoConsultado.getProgramaEbja() != null && programaGradoConsultado.getProgramaEbja().getModalidad().getNemonico().equals("MOD-03")
	...
	public void validarDatosAdicionales() {
		System.out.println("ejecuta boton continuar");
		visiblePanelE = true;
		textosalida = "";
		...
		if (procesarInscripcionPendiente) {
			...
			if (tmpPeriodoFaseOferta) {
				...
				setVisiblePanelE(true);
			}
		}
		setVisiblePanelE(true);
		System.out.println(visiblePanelE);
	}
	...
	public boolean validarRangoFechaFaseReglaNegocio() {
		...
		if ( reglaNegocio!= null && reglaNegocio.getFechaInicio().after(programaEbja.getGrupoFasePrograma().getFechaInicio()) == true && 
	...
	//BUSQUEDA DE INSTITUCIONES EDUCATIVAS
	public void obtenerProvinciasIe() {
		listaProvinciaIe = provinciaFacadeLocal.listaProvinciaPorZona(zonaIe.getCodigoSenpladesZona());
		provinciaIe = null;
		cantonIe = null;
		parroquiaIe = null;		
	}
	
	public void obtenerCantonesIe() {
		listaCantonIe = cantonFacadeLocal.listaCantonPorProvincia(provinciaIe.getCodigoProvincia());
		cantonIe = null;
		parroquiaIe = null;
	}
	
	public void obtenerParroquiasIe() {
		listaParroquiaIe = parroquiaFacadeLocal.listaParroquiaPorCanton(cantonIe.getCodigoCanton());
		parroquiaIe = null;
	}
	
	public void obtenerSostenimientoIe() {
		etiquetaInstitucionEducativa = "Institución educativa asignada:";
		if(proyectoSelecionado==TipoSostenimientoServicioEducativoEnum.SOSTENIMIENTO_EBJA.getIdServicioEducativo()) {
			sostenimientosIe = TipoSostenimientoServicioEducativoEnum.SOSTENIMIENTO_EBJA.getSostenimientos();
			etiquetaInstitucionEducativa = "Institución educativa referencial:";
		}else if(proyectoSelecionado==TipoSostenimientoServicioEducativoEnum.SOSTENIMIENTO_CPL.getIdServicioEducativo()) {
			sostenimientosIe = TipoSostenimientoServicioEducativoEnum.SOSTENIMIENTO_CPL.getSostenimientos();
		}else if(proyectoSelecionado==TipoSostenimientoServicioEducativoEnum.SOSTENIMIENTO_PCEI.getIdServicioEducativo()) {
			sostenimientosIe = TipoSostenimientoServicioEducativoEnum.SOSTENIMIENTO_PCEI.getSostenimientos();
		}
		
	}
	
	public void obtenerInstitucionesEducativas() {
		institucionesEducativas = institucEstablecFacadeLocal.institucionFindByParroquia(parroquiaIe.getId(), sostenimientoIe);
	}
	...
	public boolean isVisiblePanelE() {
		return visiblePanelE;
	}

	public void setVisiblePanelE(boolean visiblePanelE) {
		this.visiblePanelE = visiblePanelE;
	}

	public Provincia getProvinciaIe() {
		return provinciaIe;
	}

	public void setProvinciaIe(Provincia provinciaIe) {
		this.provinciaIe = provinciaIe;
	}

	public Canton getCantonIe() {
		return cantonIe;
	}

	public void setCantonIe(Canton cantonIe) {
		this.cantonIe = cantonIe;
	}

	public Parroquia getParroquiaIe() {
		return parroquiaIe;
	}

	public void setParroquiaIe(Parroquia parroquiaIe) {
		this.parroquiaIe = parroquiaIe;
	}

	public Zona getZonaIe() {
		return zonaIe;
	}

	public void setZonaIe(Zona zonaIe) {
		this.zonaIe = zonaIe;
	}

	public List<Provincia> getListaProvinciaIe() {
		return listaProvinciaIe;
	}

	public void setListaProvinciaIe(List<Provincia> listaProvinciaIe) {
		this.listaProvinciaIe = listaProvinciaIe;
	}

	public List<Canton> getListaCantonIe() {
		return listaCantonIe;
	}

	public void setListaCantonIe(List<Canton> listaCantonIe) {
		this.listaCantonIe = listaCantonIe;
	}

	public List<Parroquia> getListaParroquiaIe() {
		return listaParroquiaIe;
	}

	public void setListaParroquiaIe(List<Parroquia> listaParroquiaIe) {
		this.listaParroquiaIe = listaParroquiaIe;
	}


	public List<String> getSostenimientosIe() {
		return sostenimientosIe;
	}

	public void setSostenimientosIe(List<String> sostenimientosIe) {
		this.sostenimientosIe = sostenimientosIe;
	}

	public String getSostenimientoIe() {
		return sostenimientoIe;
	}

	public void setSostenimientoIe(String sostenimientoIe) {
		this.sostenimientoIe = sostenimientoIe;
	}

	public List<InstitucEstablec> getInstitucionesEducativas() {
		return institucionesEducativas;
	}

	public void setInstitucionesEducativas(List<InstitucEstablec> institucionesEducativas) {
		this.institucionesEducativas = institucionesEducativas;
	}

	public InstitucEstablec getInstitucionEducativa() {
		return institucionEducativa;
	}

	public void setInstitucionEducativa(InstitucEstablec institucionEducativa) {
		this.institucionEducativa = institucionEducativa;
	}

	public String getEtiquetaInstitucionEducativa() {
		return etiquetaInstitucionEducativa;
	}

	public void setEtiquetaInstitucionEducativa(String etiquetaInstitucionEducativa) {
		this.etiquetaInstitucionEducativa = etiquetaInstitucionEducativa;
	}
