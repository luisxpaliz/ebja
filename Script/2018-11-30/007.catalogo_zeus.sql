...
-- CREACION DEL GRADO NINGUNO PARA EBJA PARA EL PROGRAMA ALFABETIZACIÓN	
INSERT INTO public.grado(
id, id_nivel, descripcion, nemonico, descripcion_nemonico, siguiente_grado, mostrar_grado, fecha_creacion, estado, fecha_migracion)
VALUES (50,	1,'Ninguno','NINGUNO','NINGUNO',null,1, now(),'4',now())