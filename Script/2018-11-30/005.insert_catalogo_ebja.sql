...
INSERT INTO ebja.catalogo_ebja VALUES ((SELECT MAX(id) + 1 FROM ebja.catalogo_ebja), (SELECT MAX(id) FROM ebja.tipo_catalogo_ebja), 'INTELECTUAL',null,'INT', 1,  now(), '1',1);
...
INSERT INTO ebja.catalogo_ebja VALUES ((SELECT MAX(id) + 1 FROM ebja.catalogo_ebja), (SELECT MAX(id) FROM ebja.tipo_catalogo_ebja), 'Certificado de promoción último año',null,'C', 1,   now(), '1',1);
INSERT INTO ebja.catalogo_ebja VALUES ((SELECT MAX(id) + 1 FROM ebja.catalogo_ebja), (SELECT MAX(id) FROM ebja.tipo_catalogo_ebja), 'Lista de calificaciones',null,'L', 1,  now(), '1',1);
INSERT INTO ebja.catalogo_ebja VALUES ((SELECT MAX(id) + 1 FROM ebja.catalogo_ebja), (SELECT MAX(id) FROM ebja.tipo_catalogo_ebja), 'Título artesanal del  2002 en adelante',null,'R', 1,  now(), '1',1);
