...
create table ebja.detalle_traslado (
  ...
  id_matricula_curso_paralelo     int4,
  id_matricula_programa_institucion     int4,
  id_matricula_tipo_proceso_origen      int4,
...
ALTER TABLE ebja.detalle_traslado 
    OWNER to carmenta;


GRANT SELECT ON TABLE ebja.detalle_traslado TO backup;

GRANT ALL ON TABLE ebja.detalle_traslado TO carmenta;

GRANT SELECT ON TABLE ebja.detalle_traslado TO rol_lectura;
